        ...
        {items.items.map((i) => (
          <Col key={i.id} md={4} sm={6} xs={12}>
            <Card className="h-100 shadow-sm border-0">
              <div style={{ height: '200px', width: '100%', backgroundColor: '#f8f9fa', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                <Card.Img 
                  variant="top" 
                  src={i.imageUrl} 
                  style={{ 
              ...
              <Card.Body className="d-flex flex-column">
                ...
                <Card.Text className="fw-bold text-primary">
                  ${i.price.toLocaleString()} {/* Formatear el precio con separador de miles */}
                </Card.Text>
